...
class ClienteResourceIT {
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getNumeroContacto()).isEqualTo(DEFAULT_NUMERO_CONTACTO);
        ...
        assertThat(testCliente.getNumeroCC()).isEqualTo(DEFAULT_NUMERO_CC);
    }
    ...
    void putNewCliente() throws Exception {
        ...
        assertThat(testCliente.getNumeroContacto()).isEqualTo(UPDATED_NUMERO_CONTACTO);
        ...
        assertThat(testCliente.getNumeroCC()).isEqualTo(UPDATED_NUMERO_CC);
    }
