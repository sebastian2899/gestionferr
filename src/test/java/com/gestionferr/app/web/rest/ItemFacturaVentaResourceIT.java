...
import com.gestionferr.app.service.mapper.ItemFacturaVentaMapper;
...
class ItemFacturaVentaResourceIT {
    ...
    private static final Long DEFAULT_ID_FACTURA_VENTA = 1L;
    private static final Long UPDATED_ID_FACTURA_VENTA = 2L;
    ...
    public static ItemFacturaVenta createEntity(EntityManager em) {
        ItemFacturaVenta itemFacturaVenta = new ItemFacturaVenta()
            .idFacturaVenta(DEFAULT_ID_FACTURA_VENTA)
    ...
    public static ItemFacturaVenta createUpdatedEntity(EntityManager em) {
        ItemFacturaVenta itemFacturaVenta = new ItemFacturaVenta()
            .idFacturaVenta(UPDATED_ID_FACTURA_VENTA)
    ...
    void createItemFacturaVenta() throws Exception {
        ...
        assertThat(testItemFacturaVenta.getIdFacturaVenta()).isEqualTo(DEFAULT_ID_FACTURA_VENTA);
    ...
    void getAllItemFacturaVentas() throws Exception {
        ...
        restItemFacturaVentaMockMvc
            ...
            .andExpect(jsonPath("$.[*].idFacturaVenta").value(hasItem(DEFAULT_ID_FACTURA_VENTA.intValue())))
    ...
    void getItemFacturaVenta() throws Exception {
        ...
        restItemFacturaVentaMockMvc
            ...
            .andExpect(jsonPath("$.idFacturaVenta").value(DEFAULT_ID_FACTURA_VENTA.intValue()))
    ...
    void putNewItemFacturaVenta() throws Exception {
        ...
        ItemFacturaVenta testItemFacturaVenta = itemFacturaVentaList.get(itemFacturaVentaList.size() - 1);
        assertThat(testItemFacturaVenta.getIdFacturaVenta()).isEqualTo(UPDATED_ID_FACTURA_VENTA);
    ...
    void partialUpdateItemFacturaVentaWithPatch() throws Exception {
        ...
        partialUpdatedItemFacturaVenta.idFacturaVenta(UPDATED_ID_FACTURA_VENTA);
